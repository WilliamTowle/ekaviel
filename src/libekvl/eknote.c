...
void zap_notes()
{
	if (perTable != NULL)
	{
	    FREE_MEMORY(perTable); perTabSz= 0; perTable= NULL;
	}

	if (ftuTable != NULL)
	{
	    FREE_MEMORY(ftuTable); ftuTable= NULL;
	}

	if (ptchName != NULL)
	{
	    FREE_MEMORY(ptchName); ptchName= NULL;
	}
}
